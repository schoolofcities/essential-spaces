...
<div id="panel">
	...
	<p>
		This map examines the real estate landscape of the Greater Toronto Area's (GTA) community services sector as of 2021. The map allows us to analyze the location of a sample of owned and leased agency spaces offering services in Peel, Toronto and York Region and their proximity to equity-seeking groups, providing insight into risks and opportunities for preserving and developing real estate within the community services sector. <a href="https://www.unitedwaygt.org/the-work/research-and-reports/?utm_medium=print&utm_term=qr_code&utm_source=bookmark&utm_content=read-report&utm_campaign=community-realestate" target="_blank">Click here to read our research report</a>.
	</p>
